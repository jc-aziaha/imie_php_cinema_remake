...
session_start();
    ...
    if ( "POST" === $_SERVER['REQUEST_METHOD'] ) 
    {
        ...
        $request = $db->prepare("INSERT INTO film (name, actors, review, comment, created_at, updated_at) VALUES (:name, :actors, :review, :comment, now() , now() ) ");
...
<?php
    ...
    $keywords = "imie, php, nouveau film";
?>
